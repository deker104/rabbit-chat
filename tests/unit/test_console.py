...
async def test_input_loop_quit():
    ...
    with (
        patch("rabbit_chat.console.ainput", side_effect=["!quit"]),
...
async def test_input_loop_switch_channel():
    ...
    with (
        patch("rabbit_chat.console.ainput", side_effect=["!switch newchan", "!quit"]),
        patch("rabbit_chat.console.aprint"),
    ):
        await console.input_loop()
...
async def test_input_loop_send_message():
    ...
    with (
        patch("rabbit_chat.console.ainput", side_effect=["hello there", "!quit"]),
        patch("rabbit_chat.console.aprint"),
    ):
        await console.input_loop()
